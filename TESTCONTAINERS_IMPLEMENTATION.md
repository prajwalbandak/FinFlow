...
**Updated `tests\FinFlow.FunctionalTests\FinFlow.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\FinFlow.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\FinFlow.FunctionalTests\FinFlow.FunctionalTests.csproj
```
